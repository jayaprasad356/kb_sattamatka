...
define('DOMAIN_URL', 'https://admin.dpbossmatka.info/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u713985783_dpboss";  // Change as required
    private $db_pass = "Dpboss@2022";  // Change as required
    private $db_name = "u713985783_dpboss";    // Change as required
